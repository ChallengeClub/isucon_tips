...
## 募集の概要
<img src="./images/技術チャレンジ部_第29回_ISUCONr2.png" width="90%">
...
参加には私用PCとgithubとDiscordのアカウントが必要です。  
週１回火曜に90分素振り会しますので、そこに参加いただくのがスムーズ。  
木曜はもくもく会します。自分の都合のいい時だけ参加すればＯＫです。  
練習参加はいつからでもＯＫです。使う言語は本戦までにチームで相談(去年はGoとRust)。  
本戦参加の締め切りは本戦チーム登録が〆切になる10月一杯目途になります。 
