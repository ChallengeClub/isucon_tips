...
- 全員分の公開鍵を用意しておけばEC2の作成直後から皆自分の鍵でssh接続できるはず。
  - 全員分の[autorized_keys](https://github.com/ChallengeClub/isucon_tools/blob/680097f80876da33d72f9b3e6bdc98a0e4485a5d/authorized_keys)を用意したがAWSコンソールに直接貼るには長すぎた。EC2起動script等の方法使いましょう。
